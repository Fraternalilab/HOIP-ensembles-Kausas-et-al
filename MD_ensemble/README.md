- **MD_traj**: contains a model of the extended HOIP RBR domain. The simulation trajectory file can be found in the Zenodo [repository](https://zenodo.org/record/6583368).
